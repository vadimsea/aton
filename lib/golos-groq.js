...
async function fetchGolosReply(userText, { username, displayName, fromVoice = false } = {}) {
  ...
  const system = [
    ...
    fromVoice
      ? "Собеседник прислал голосовое: отвечай коротко, 1–3 предложения, удобно для прослушивания."
      : null,
  ]
    .filter(Boolean)
    .join(" ");
